...
%
Accordingly, the aim is to speed up existing and new logic programs without any change to the code.
...
The technology for sequential implementation of logic programming languages has evolved considerably since its birth.
%
...
For years logic programming has been considered well suited for execution on multiprocessor architectures.
%
Indeed research in concurrent logic programming is vast and dates back to the inception of logic programming itself.
%
...
However, in practice, software solutions were built on top of
...
ConcurrentSolver API: generic type for concurrent solvers

support for primitives in concurrent resolution

design and formalization of OR-concurrent Prolog-like solvers

OR-concurrent solver module for 2p-kt
