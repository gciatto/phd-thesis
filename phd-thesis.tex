...
\paragraph{Robinson's proposal of the selective linear resolution principle}
...
%
The basic inference rule operating in this context is that, in a set of Skolemized formul\ae{} $\mathbf{K}$ including $\phi$ and $\psi$, those formul\ae{} may be reduced $\phi'$ and $\psi'$, under the following condition:
%
\begin{equation*}
...
\paragraph{Kowalsky's proposal of the selective linear definite resolution principle}
