...
\note{
- in symbolic representations data and knowledge are represented uniformly
    + in sub-symbolic representations numbers, and vectors carry information about data, while knowledge is captured by functions
%
- exploitation of rigid vectors, matrices, or tensors of real numbers to extensively represent data
    + may be either local or distributed
%
- despite numbers are technically symbols, we cannot consider tensors or functions of tensors as symbolic
    + to be symbolic, a KR approach should i) involve a set of symbols, ii) which can be combined following grammatical rules, iii) where both elementary symbols and any admissible combination of symbols are endowed with meaning---i.e. can be mapped into some entity from the domain of the discourse. 
%
- feature engineering to handles cases where data is not numeric or not rigid
    + non-numeric to numeric
        * ordinal vs. categorical
        * one-hot encoding
    + flexible to rigid (tackling distribution)
        * embedding
        * drawing statistics
        * sliding window
        * feature engineering
