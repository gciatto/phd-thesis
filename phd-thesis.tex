...
\begin{table}
    ...
    \end{array}$$
    \caption{Context-free grammar for FOL. Sans-serif words among angular brackets denote non-terminal symbols, whereas symbols among single apices denote terminal symbols.}
...
%
Similarly to predicates, structures may carry $N \geq 0$ terms.
%
When this is the case, the structure is said $N$-ary as well.
%
