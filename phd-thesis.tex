...
%
There, the meta-rule \ref{eq:meta-rule-example} may suggest the correct identification of the target rule -- namely, $grandparent(X, Y) \leftarrow parent(X, Z), parent(Z, Y)$ -- via the variable assignment $\{ \textsf{P} \mapsto \functor{grandparent}, \textsf{Q} \mapsto \functor{parent}, \textsf{R} \mapsto \functor{parent} \}$.
...
\section{Symbolic vs. Sub-Symbolic Supervised Learning}
