...
Decision trees (DT) are a particular sort of predictors supporting both classification and regression tasks.
%
...
Neural networks (NN) are biologically-inspired computational models, made of several elementary units (neurons) interconnected into a graph (commonly, \emph{directed} and \emph{acyclic}, i.e. DAG) via \emph{weighted} synapses.
%
...
NN can be \emph{trained} on data via stochastic gradient descent and exploited into both supervised and unsupervised learning tasks such as classification, regression, and anomaly detection, depending on the particular architecture of choice.
%
More precisely, while the training phase sets up weights of each neuron's ingoing synapses automatically, the overall topology of the network is not allowed to vary.
%
