...
Unification as the basic mechanism enabling the formalization of inference.

Rules as precondition-effect fractions: how to read them.

Examples of inference rules: modus ponens, modus tollens, subsumption, abduction

Classification of rules: modus ponens/tollens as deductive, subsumption as inductive, abduction is abductive.

Notice that only deductive rules lead to absolutely correct conclusions.

Discussion on how bayesian inference may be better suited to represent inductive or abductive inferece, yet it requires trepassing the sub-symbolic domain as probabilities must be explicitly represented.
