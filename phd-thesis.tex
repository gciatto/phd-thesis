...
%
Here we focus, on their flexibility, data and computational efficiency, degree of automation, maturity, and validation.
...
Conversely, sub-symbolic approaches are aimed at learning \emph{functions}, rather than relations.
%
...
%
NN are characterised by a great flexibility because of their reliance on differentiable operators (mostly sums, multiplications and activation functions \cite{enwiki:ActivationFunctions}), and malleable way of combining them into arbitrarly complex structures.
%
...
%
Data efficiency deals with space, and it is related to the amount of data required by learning to be effective.
%
Computational efficiency deals with time, and it is related the amount of time required by learning to be effective.
%
In both cases, effectivess refers to the adherence of the learned relation/function w.r.t. the available examples.

Concerning data efficiency, sub-symbolic approaches are notably data-hungry \cite{Adadi21}, requiring tons of examples to learn tasks for which a human would require just a handful.
%
Conversely, symbolic approaches are considered far more data-efficient \cite{EvansG18}.
