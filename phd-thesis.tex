...
%\\
%Mi piace far ricerca e bere vino, mi piace far casino, poi sono nato fesso.
%\\
%E quindi tiro avanti e non mi svesto dei panni che son solito portare.
%\\
%Ho tante cose ancora da raccontare per chi vuole ascoltare \ldots
...
%
This is not the first time in history that AI attains unprecedented levels of attention, expectations, and fundings, yet it is the first time that such momentum is driven by a pervasive adoption of data science (DS) and, in particular, machine learning (ML).
